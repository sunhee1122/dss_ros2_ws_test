...
#ifndef DSS_LIO_SAM__MSG__DETAIL__CLOUD_INFO__STRUCT_HPP_
#define DSS_LIO_SAM__MSG__DETAIL__CLOUD_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dss_lio_sam__msg__CloudInfo __attribute__((deprecated))
#else
# define DEPRECATED__dss_lio_sam__msg__CloudInfo __declspec(deprecated)
#endif
...
struct CloudInfo_
{
  ...
  // pointer types
  using RawPtr =
    dss_lio_sam::msg::CloudInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const dss_lio_sam::msg::CloudInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dss_lio_sam::msg::CloudInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dss_lio_sam__msg__CloudInfo
    std::shared_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dss_lio_sam__msg__CloudInfo
    std::shared_ptr<dss_lio_sam::msg::CloudInfo_<ContainerAllocator> const>
...
using CloudInfo =
  dss_lio_sam::msg::CloudInfo_<std::allocator<void>>;
...
#endif  // DSS_LIO_SAM__MSG__DETAIL__CLOUD_INFO__STRUCT_HPP_

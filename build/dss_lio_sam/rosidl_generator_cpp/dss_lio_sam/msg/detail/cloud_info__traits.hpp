...
#ifndef DSS_LIO_SAM__MSG__DETAIL__CLOUD_INFO__TRAITS_HPP_
#define DSS_LIO_SAM__MSG__DETAIL__CLOUD_INFO__TRAITS_HPP_
...
[[deprecated("use dss_lio_sam::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dss_lio_sam::msg::CloudInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
  dss_lio_sam::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use dss_lio_sam::msg::to_yaml() instead")]]
inline std::string to_yaml(const dss_lio_sam::msg::CloudInfo & msg)
{
  return dss_lio_sam::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dss_lio_sam::msg::CloudInfo>()
{
  return "dss_lio_sam::msg::CloudInfo";
}

template<>
inline const char * name<dss_lio_sam::msg::CloudInfo>()
{
  return "dss_lio_sam/msg/CloudInfo";
}

template<>
struct has_fixed_size<dss_lio_sam::msg::CloudInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dss_lio_sam::msg::CloudInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<dss_lio_sam::msg::CloudInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DSS_LIO_SAM__MSG__DETAIL__CLOUD_INFO__TRAITS_HPP_

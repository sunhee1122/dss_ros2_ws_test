...
bool dss_lio_sam__msg__cloud_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dss_lio_sam.msg._cloud_info.CloudInfo", full_classname_dest, 37) == 0);
  }
  dss_lio_sam__msg__CloudInfo * ros_message = _ros_message;
  {  // header
...
PyObject * dss_lio_sam__msg__cloud_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dss_lio_sam.msg._cloud_info");

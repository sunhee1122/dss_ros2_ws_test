...
class Metaclass_SaveMap_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('dss_lio_sam')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dss_lio_sam.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from dss_lio_sam.srv._save_map import SaveMap_Request as Request
    from dss_lio_sam.srv._save_map import SaveMap_Response as Response

...
#ifndef DSS_LIO_SAM__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
#define DSS_LIO_SAM__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
 ...
 * calls
 * dss_lio_sam__srv__SaveMap_Request__init().
...
/**
 * It calls
 * dss_lio_sam__srv__SaveMap_Request__fini()
 ...
 * dss_lio_sam__srv__SaveMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dss_lio_sam__srv__SaveMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dss_lio_sam__srv__SaveMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dss_lio_sam
...
/**
 * It calls
 * dss_lio_sam__srv__SaveMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dss_lio_sam
...
/**
 * It allocates the memory for the array and calls
 * dss_lio_sam__srv__SaveMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dss_lio_sam
...
/**
 * It calls
 * dss_lio_sam__srv__SaveMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DSS_LIO_SAM__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_

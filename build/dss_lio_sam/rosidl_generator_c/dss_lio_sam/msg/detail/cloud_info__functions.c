...
bool
dss_lio_sam__msg__CloudInfo__init(dss_lio_sam__msg__CloudInfo * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    dss_lio_sam__msg__CloudInfo__fini(msg);
    return false;
  }
  // start_ring_index
...
void
dss_lio_sam__msg__CloudInfo__fini(dss_lio_sam__msg__CloudInfo * msg)
{
  if (!msg) {
    return;
  }
...
bool
dss_lio_sam__msg__CloudInfo__are_equal(const dss_lio_sam__msg__CloudInfo * lhs, const dss_lio_sam__msg__CloudInfo * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
dss_lio_sam__msg__CloudInfo__copy(
  const dss_lio_sam__msg__CloudInfo * input,
  dss_lio_sam__msg__CloudInfo * output)
{
  if (!input || !output) {
    return false;
  }
...
dss_lio_sam__msg__CloudInfo *
dss_lio_sam__msg__CloudInfo__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dss_lio_sam__msg__CloudInfo * msg = (dss_lio_sam__msg__CloudInfo *)allocator.allocate(sizeof(dss_lio_sam__msg__CloudInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dss_lio_sam__msg__CloudInfo));
  bool success = dss_lio_sam__msg__CloudInfo__init(msg);
  if (!success) {
...
void
dss_lio_sam__msg__CloudInfo__destroy(dss_lio_sam__msg__CloudInfo * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dss_lio_sam__msg__CloudInfo__fini(msg);
...
bool
dss_lio_sam__msg__CloudInfo__Sequence__init(dss_lio_sam__msg__CloudInfo__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dss_lio_sam__msg__CloudInfo * data = NULL;

  if (size) {
    data = (dss_lio_sam__msg__CloudInfo *)allocator.zero_allocate(size, sizeof(dss_lio_sam__msg__CloudInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dss_lio_sam__msg__CloudInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dss_lio_sam__msg__CloudInfo__fini(&data[i - 1]);
      }
...
void
dss_lio_sam__msg__CloudInfo__Sequence__fini(dss_lio_sam__msg__CloudInfo__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dss_lio_sam__msg__CloudInfo__fini(&array->data[i]);
    }
...
dss_lio_sam__msg__CloudInfo__Sequence *
dss_lio_sam__msg__CloudInfo__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dss_lio_sam__msg__CloudInfo__Sequence * array = (dss_lio_sam__msg__CloudInfo__Sequence *)allocator.allocate(sizeof(dss_lio_sam__msg__CloudInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dss_lio_sam__msg__CloudInfo__Sequence__init(array, size);
  if (!success) {
...
void
dss_lio_sam__msg__CloudInfo__Sequence__destroy(dss_lio_sam__msg__CloudInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dss_lio_sam__msg__CloudInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
dss_lio_sam__msg__CloudInfo__Sequence__are_equal(const dss_lio_sam__msg__CloudInfo__Sequence * lhs, const dss_lio_sam__msg__CloudInfo__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dss_lio_sam__msg__CloudInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
dss_lio_sam__msg__CloudInfo__Sequence__copy(
  const dss_lio_sam__msg__CloudInfo__Sequence * input,
  dss_lio_sam__msg__CloudInfo__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dss_lio_sam__msg__CloudInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dss_lio_sam__msg__CloudInfo * data =
      (dss_lio_sam__msg__CloudInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dss_lio_sam__msg__CloudInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dss_lio_sam__msg__CloudInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dss_lio_sam__msg__CloudInfo__copy(

...
#include "dss_lio_sam/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dss_lio_sam::srv::SaveMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dss_lio_sam::srv::SaveMap_Request & ros_message)
{
  // Member: resolution
  cdr >> ros_message.resolution;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dss_lio_sam::srv::SaveMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dss_lio_sam::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dss_lio_sam::srv::SaveMap_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dss_lio_sam
const rosidl_message_type_support_t *
get_message_type_support_handle<dss_lio_sam::srv::SaveMap_Request>()
{
  return &dss_lio_sam::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dss_lio_sam, srv, SaveMap_Request)() {
  return &dss_lio_sam::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dss_lio_sam
cdr_serialize(
  const dss_lio_sam::srv::SaveMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dss_lio_sam::srv::SaveMap_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dss_lio_sam::srv::SaveMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dss_lio_sam::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dss_lio_sam::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dss_lio_sam::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dss_lio_sam, srv, SaveMap_Response)() {
  return &dss_lio_sam::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
{
  return &dss_lio_sam::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dss_lio_sam, srv, SaveMap)() {
  return &dss_lio_sam::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}

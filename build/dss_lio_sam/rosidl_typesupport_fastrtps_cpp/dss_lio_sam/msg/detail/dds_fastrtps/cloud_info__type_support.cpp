...
#include "dss_lio_sam/msg/detail/cloud_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dss_lio_sam::msg::CloudInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dss_lio_sam::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dss_lio_sam::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  return &dss_lio_sam::msg::typesupport_fastrtps_cpp::_CloudInfo__handle;
}

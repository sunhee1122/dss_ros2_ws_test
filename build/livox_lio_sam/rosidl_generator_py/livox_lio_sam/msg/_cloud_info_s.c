...
bool livox_lio_sam__msg__cloud_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("livox_lio_sam.msg._cloud_info.CloudInfo", full_classname_dest, 39) == 0);
  }
  livox_lio_sam__msg__CloudInfo * ros_message = _ros_message;
  {  // header
...
PyObject * livox_lio_sam__msg__cloud_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("livox_lio_sam.msg._cloud_info");

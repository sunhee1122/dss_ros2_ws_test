...
class Metaclass_Reset_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('livox_lio_sam')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Reset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from livox_lio_sam.srv import _reset
...
class Reset(metaclass=Metaclass_Reset):
    from livox_lio_sam.srv._reset import Reset_Request as Request
    from livox_lio_sam.srv._reset import Reset_Response as Response

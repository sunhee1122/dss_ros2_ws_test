...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from livox_lio_sam.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from livox_lio_sam.srv._save_map import SaveMap_Request as Request
    from livox_lio_sam.srv._save_map import SaveMap_Response as Response

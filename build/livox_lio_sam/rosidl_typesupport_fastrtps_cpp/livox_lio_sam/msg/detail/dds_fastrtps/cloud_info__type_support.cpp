...
#include "livox_lio_sam/msg/detail/cloud_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = livox_lio_sam::msg::CloudInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const livox_lio_sam::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<livox_lio_sam::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  return &livox_lio_sam::msg::typesupport_fastrtps_cpp::_CloudInfo__handle;
}
